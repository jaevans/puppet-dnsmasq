...
class dnsmasq (
  ...
  Optional[String[1]] $dnsmasq_package_provider,
  String[1] $dnsmasq_service,
  Array[String[1]] $auth_sec_servers         = undef,
  String[1] $auth_server              = undef,
  Integer $auth_ttl                 = undef,
  String[1] $auth_zone                = undef,
  Boolean $bogus_priv               = true,
  Integer $cache_size               = 1000,
  Hash $config_hash              = {},
  Optional[String[1]] $dhcp_boot                = undef,
  Stdlib::Absolutepath $dhcp_leasefile           = undef,
  ...
  Option[Stdlib::IP::Address::V4::Nosubnet] $no_dhcp_interface        = undef,
